...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,  "Shift"  }, "e",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "layout"}),
    awful.key({ modkey,  "Shift"  }, "q",     function () awful.tag.incmwfact(-0.05)          end,
    ...
    awful.key({ modkey, "Shift" }, "w",     function () awful.tag.incncol( 1, nil, true)    end,
